...
{
    PTYTextView* textView = [self TEXTVIEW];
    if (!textView) {
        _findActive = NO;
        return NO;
    }
    
    _findLastX = _findOriginX = [textView getFindOriginX];
    _findLastY = _findOriginY = [textView getFindOriginY];
    _findActive = YES;
    _findDirection = direction;
    _caseCheck = caseCheck;
    
    return [textView partialSearchFor:subString
                     forwardDirection:direction
                         ignoringCase:caseCheck
                             startAtX:_findLastX
                             startAtY:_findLastY
                          stopBeforeX:_findOriginX
                          stopBeforeY:_findOriginY];
}
